...
| `GRAPHMIND_ABANDON_GRACE_MS` | How long a run whose app disconnected mid-flight waits to reconnect before it is marked abandoned rather than left "running" forever. |
