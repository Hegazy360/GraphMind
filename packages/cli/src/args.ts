...
export const OPTION_HELP: readonly string[] = [
  ...
  '                 Default off (nothing). resume = continue/retry/abort, and',
  '                 set breakpoints / step mode (they decide which calls hold)',
  '                 and start the demo; inject adds injecting a result; edit',
  '                 adds editing a held call\'s input',
  '  --no-edit-input',
