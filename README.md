...
More than 5,000 tests — 5,008 on the 0.6.0 build, counted by [`apps/docs/scripts/count-tests.mjs`](./apps/docs/scripts/count-tests.mjs) (re-run it with `--run` rather than trusting this line). Beyond the unit suites, the ones worth knowing about:
